...
const ProfileForm = () => {
  ...
  const submitHandler = async (e) => {
        ...
        const resp = await fetch("https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyCJO3nf1rN9288u3VAFDm0kC3eqhRSqPKc", {
            method: "POST",
            body: JSON.stringify({
                idToken: token,
        ...
        <div className=" mt-10 w-2/3 mr-2">
          ...
          <div className="mt-5">
            <form onSubmit={submitHandler}>
              ...
              <button type="submit" className="mt-5 m-1 bg-red-500 text-white border border-red-400 rounded-md p-1 font-medium ">
                Update
              </button>
            </form>
          </div>
